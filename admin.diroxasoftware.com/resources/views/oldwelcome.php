                  ...
                  <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                          <a href="/section/buysection/index" style="color:black"> PRODUCTS IN STOCK</a>
                          </div>
                          <div class="row no-gutters align-items-center">
                            <div class="col-md-6">
                                <h2><b>{{$Nproducts}} products</b></h2>
                                  <br>
                                  <a type="button" href="/section/reports/products" class="btn btn-info">
                                  <i class="fa fa-eye fa-1x " aria-hidden="true"></i>
                                      <b>SEE ALL PRODUCTS</b>
                                  </a>
                            </div>
                            <div class="col">
                            </div>
                  ...
                  <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                          <a href="/section/buysection/index" style="color:black"> CART</a>
                          </div>
                          <div class="row no-gutters align-items-center">
                            <div class="col-md-6">
                  ...
                  <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                          <a href="/section/sales/allsales" style="color:black"> SEE ALL SALES SO FAR</a>
                          </div>
                  ...
                  <div class="card border-left-dark shadow h-100 py-2">
                    <div class="card-body">
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                          <a href="/section/quote" style="color:black"> Appointments for Today</a>
                          </div>
                              <h1><b>{{$Nappointments}} today</b></h1>
                              <br>
                              <a type="button" href="/section/appointments/index" class="btn btn-info">
                              <i class="fa fa-eye fa-1x " aria-hidden="tru  e"></i>
                                  <b>SEE ALL APPOINTMENTS</b>
                              </a>
                        </div>
                      </div>
                    </div>
