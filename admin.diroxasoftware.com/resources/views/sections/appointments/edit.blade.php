...
<head>
  ...
  <script type="text/javascript" src="{{ asset('jquery/multiselect/chosen.jquery.min.js') }}"></script>
    ...
    <form action="/section/appointments/update" method="POST" id="registro" name="registro" enctype="multipart/form-data">
        @csrf
        <section class="testimonial py-3" id="testimonial">
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            <h4 class="pb-2" style="color:black;"><b>Edditing a Appointement</b></h4>
                      ...
                      @endif
                                ...
                                <div class="form-row">
                                    ...
                                    <label for="" style="text-align:center;color:black;"><b>Title</b></label>
                                        <input id="name" name="name"  id="name"
                                         value="{{$allAppointment->name}}"
                                         placeholder="Keep it empty for no title" class="form-control" type="text"
                                         required>
                                    </div>

                                    <?php
                                        $appointmentDate = date('d/m/Y H:i', strtotime($allAppointment->appointmentHoursDate));
                                    ?>
                                    ...
                                    <label for="" style="text-align:center;color:black;"><b>Choose Date</b></label>
                                        ...
                                        value="{{$allAppointment->appointmentHoursDate}}"
                            ...
                            <input type="text" value="{{$allAppointment->id}}" name="appointmentId" id="appointmentId" hidden>
                                  ...
                                  <label for="" style="color:black;"><b> Observation: </b></label>
                                      ...
                                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                          name="about" placeholder="Observation"
                                           value="{{$allAppointment->about}}"  id="about" >{{$allAppointment->about}}</textarea>
                              </div>

                          </div>
                              <button type="submit" class="btn btn-success">
                              <i class="fa fa-check fa-1x " aria-hidden="true"></i>
                              <b>Update Appointement</b></button>
