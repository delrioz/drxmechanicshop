...
<head>
  ...
  <script src="{{ asset('buysection/js/buy.js') }}" async></script>
        ...
        productosLS.forEach(function (producto){
            ...
            row.innerHTML = `
                ...
                <td>
                    ...
                    <a href="#" class="borrar-producto fas fa-times-circle" onclick="eliminarProductoLocalStorage(${producto.id})" style="font-size:30px" data-id="${producto.id}"></a>
                </td>
            `;
