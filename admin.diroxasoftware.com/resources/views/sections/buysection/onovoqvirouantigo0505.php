                        ...
                        <div class="col-md-12 py-5 border" id="lista-productos">
                            ...
                            <div class="row">
                                ...
                                <label style="color:black;"><b>Quantity</b></label>
                                    <input type="number" id="quantity" name="quantity"  id="quantity"  placeholder="Search for a product" 
                                        value ="1" type="text" >
                                </div>
                            </div>
                                      ...
                                      <div id="carrito" class="form-group table-responsive" >
                                          <table class="table" id="lista-compra" >
                                              ...
                                              <tbody class="prodstables" id="prodstables">
                                                ...
                                                <button type="button" class="btn btn-info" name="refreshBalance" id="refreshBalance">Refresh Balance</button>
                                              <tr>
               ...
               $.ajax({
                  ...
                  success: function(result){
                    ...
                    if($resp == 0){
                        ...
                        //             <td>
                        //                 <input type="number" class="form-control cantidad" id="quantity"  min="1" value=${infoProducto.cantidad}>
                        //             </td>
                                
                        //             <td id='vatsubtotales'>1</td>
                        //             <td id='subtotales'>1</td>
                        //             <td>
                                    
                        //                 <a href="#" class="removeRow fas fa-times-circle"  id="removeRow" name="removeRow"  style="font-size:30px" data-id="${infoProducto.id}"></a>
                        //             </td>
                        //         </tr>
                        // `);
...
<script>
    ...
    function addrow(infoProducto){
        console.log('infoProducto');
            var vatsubtotales = infoProducto.precio * 0.20;
            var vatsubtotalesArredondado = parseFloat(vatsubtotales.toFixed(2));


            var subtotales = (infoProducto.precio * infoProducto.cantidad) + infoProducto.precio * 0.20;
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="title[]" name="title" id="title"  value=${infoProducto.titulo}>
                </td>

                <td>
                    <input type="text" class="form-control" name="title[]" name="precio" id="precio"  value=${infoProducto.precio}>
                </td>

                <td>
                    <input type="number" class="form-control cantidad" name="quantity[]" id="quantity"  min="1" value=${infoProducto.cantidad}>
                </td>
    ...
    function  leerLocalStorageCompra(){
        ...
        productosLS.forEach(function (producto){
            ...
            var subtotales =  (producto.precio * 1.20) * producto.cantidad;
            var subtotalesArredondado = parseFloat(subtotales.toFixed(2));
            ...
            row.innerHTML = `
                ...
                <td>
                    <input type="text" class="form-control" name="title[]" id="title"  value=${producto.titulo}>
                </td>

                <td>
                    <input type="text" class="form-control" name="price[]" id="price"  value=${producto.precio}>
                </td>
                
                <td>
                    <input type="number" class="form-control" name="quantity[]" id="quantity"  min="1" value=${producto.cantidad}>
                </td>
...
<script>
    ...
    refreshBalance.addEventListener('click', (e)=>{calcularTotal(e)});
