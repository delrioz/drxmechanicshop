                ...
                <div class="card-body p-0">
                    ...
                    ?>
                        <div class="col-md-6 text-right">
                            <p class="font-weight-bold mb-1">Invoice #{{$salesId}}</p>
                    ...
                    <div class="row p-5">
                     <h3><p class="font-weight-bold mb-4">Invoice from : <strong>Products Sales</strong></h3></p>
                        <div class="col-md-12">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-0 text-uppercase small font-weight-bold">SUB TOTAL(excl VAT)</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">Quantity</th>
                                        <th class="border-0 text-uppercase small font-weight-bold">SUB TOTAL (incl VAT)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($ProductsInfos as $product)
                                    <tr>
                                        ...
                                        <td>£{{$product->totalSalesWithoutVat}}</td>
                                        <td>{{$product->quantity}}</td>
                                        <td>£{{$product->totalSalesWithVat}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                        <h4><p class="font-weight-bold mb-4">Payment method: <strong>{{$methodPayment}}</strong></p></h4>
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-row-reverse bg-dark text-white p-4">
                        <div class="py-3 px-5 text-right">
                            ...
                            <div class="h2 font-weight-light">£{{$sales_price}}</div>
                        </div>

                        <div class="py-3 px-5 text-right">
                            <div class="mb-2">VAT</div>
                            <div class="h2 font-weight-light">£{{$sales_vat}}</div>
                        </div>

                        <div class="py-3 px-5 text-right">
                            <div class="mb-2">Discount</div>
                            <div class="h2 font-weight-light">£{{$sales_discount}}</div>
                        </div>

        
                        <div class="py-3 px-5 text-right">
                            <div class="mb-2">Sub - Total amount (VAT excl)</div>
                            <div class="h2 font-weight-light">£{{$sales_subtotal}}</div>
                        </div>
                    </div>
                </div>
            </div>
