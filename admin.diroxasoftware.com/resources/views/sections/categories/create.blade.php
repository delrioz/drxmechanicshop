      ...
      <span>
        ...
        @endif
         ...
         <!------ Include the above in your HEAD tag ---------->
            ...
            <form action="/section/categories/store" method="POST" id="registro" name="registro" enctype="multipart/form-data">
                            @csrf
                            ...
                            <h4 class="pb-2" style="color:black;"><b>Adding a Supplier. Please, fill out the form.</b></h4>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for="" style="color:black;"><b> About:</b> <small style="color:red;">(NOT REQUIRED)</small></label>
                                            <div class="form-group col-md-12">
