        ...
        <div class="row ">
            <div class="col-md-4 py-5 bg-primary text-white text-center "
             id="btnRoxo">
                <div class=" ">
                    <div class="card-body">
                        <h2 class="py-3">Editing new Customers</h2>
                <br>
                      </div>
                  </div>
              </div>
                  ...
                  <h4 class="pb-4">Por favor, preencha todos os campos.</h4>
                      ...
                      <div class="form-row">
                          <div class="form-group col-md-12">
                            ...
                            value="{{$allcustomers->name}}" required autocomplete="name" required>
                          </div>
                         </div>
                      ...
                      <div class="form-row">
                          ...
                          <input id="nationality" name="nationality" 
		                        maxlength="191" 
		                         placeholder="Nationality" class="form-control" type="text"type="text" 
                                 value="{{$allcustomers->nationality}}" required autocomplete="nationality" required required>
                          	...
                          	<div class="form-group col-md-6">
		                        <input id="address" name="address" 
                                 ...
                                 value="{{$allcustomers->address}}" required autocomplete="address" required>
	                        </div>
                       </div>
                      ...
                      <div class="form-row">
                          ...
                          <input id="email" name="email" 
                                 ...
                                 value="{{$allcustomers->email}}" required autocomplete="email"required>
                          	...
                          	<div class="form-group col-md-6">
		                        <input id="nameofbusiness" name="nameofbusiness" 
		                          maxlength="191" 
		                         placeholder="Name of business" class="form-control" type="text"
                                 value="{{$allcustomers->nameofbusiness}}" required autocomplete="nameofbusiness" required>
	                        </div>
                       </div>
