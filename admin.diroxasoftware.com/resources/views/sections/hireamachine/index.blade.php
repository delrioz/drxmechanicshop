      ...
      <span>
       ...
       <!-- Page Heading -->
         ...
         <!------ Include the above in your HEAD tag ---------->
            ...
            <form  id="myForm" enctype="multipart/form-data" action="/section/hireamachine/customersforhiring/store" method="POST">
                            @csrf
            <section class="testimonial py-3" id="testimonial">
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            <h4 class="pb-2" style="color:black;"><b>Creating a Customer. Please, fill out the form</b></h4>
                              <div class="invalidData" role="alert">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                    <label for="" style="color:black;"> <b>Address:</b> </label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                   <label for="" style="color:black;"><b>Choose a Profile Image</b></label>
                                   <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                  name="image" >
                              </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                   <label for="" style="color:black;"><b>Id</b></label>
                                   <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                  name="idimage" >
                              </div>
                                        <div class="form-row">
                                                <div class="form-group col-md-12">
                                            <label for="" style="color:black;"><b>Proof of address</b></label>
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1"
                                            name="proofOfAddress" >
                                        </div>
                                </div>
                                ...
                                <b>Create and Add Machine</b></button>
                                @if(isset($backRoute))
                                    @if($backRoute == 'welcomePage')
                                    <a type="button" href="{{route('welcome') }}"  class="btn btn-danger"><b>Back</b></a>
                                    @else
                                        <a type="button" href="{{route('customer.index') }}"  class="btn btn-danger"><b>Back</b></a>
                                    @endif
                                  @endif
