...
<div class="container-fluid invoice-container">
  ...
  <!-- <div class="row">
      <div class="col-md-6">
          <p class="font-weight-bold" style="color:black;">Customer name: ______________</p>
      </div>
      <div class="col-md-6">
        <p class="font-weight-bold" style="color:black;">Date: ______________</p>
        <br>
      </div>
 </div>

 <div class="row">
    <p class="font-weight-bold" style="color:black;">Customer signature: ________________</p>
 </div> -->
    ...
    <div class="card-body px-2">
      ...
      @if(isset($routebacktoviewpage))
        <div class="btn-group btn-group-sm d-print-none"> <a href="javascript:window.print()" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-print"></i> Print</a>
              <a href="/section/allhiremachiness/viewPage/{{$allhiremachines->hiringMachineId}}/{{$findThisCustomer->id}}/OPEN" class="btn btn-danger border text-black-50 shadow-none" style="color:white!important;"><i class="fa fa-back"></i> Back</a>
        </div>
      @else
        <div class="btn-group btn-group-sm d-print-none"> <a href="javascript:window.print()" class="btn btn-light border text-black-50 shadow-none"><i class="fa fa-print"></i> Print</a>
