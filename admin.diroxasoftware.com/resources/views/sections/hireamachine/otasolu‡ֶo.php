                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        ?>
                                                      ...
                                                      <div class="form-group col-md-4">
                                                            <label for="" style="color:black;"><b>SELECT TYPE HIRING</b></label>
                                                                        <select id="typehiring" name="typehiring" class="form-control categoriesOptions" >
                                                                            <option value="4">Choose Dates</option>
                                                ...
                                                <span id="chooseDateSection" name="chooseDateSection">
                                                          <h5><b>Price per day: £{{ $thisMachine->price}}</b></h5>
                                              ...
                                              <div class="form-row">
                                                ...
                                                <input type="text" id="inputStartHiring"  name="inputStartHiring" >
                                                <input type="text" id="inputfinishHiring" name="inputfinishHiring" >
                                                <input type="text" id="inputTotalDays"    name="inputTotalDays" >
                                                <input type="text" id="inputHiringPrice"  name="inputHiringPrice" >
                                    </div>
                            </div>
              ...
              $(document).on("change", "#typehiring", function(e){
               e.preventDefault();
                ...
                if(typehiring == 4)
                {
                    ...
                    document.getElementById("todayDateNoFormated").value =  "";
                    ...
                    document.getElementById("totalDays").innerHTML = "Total days : ";
                    document.getElementById("startHiring").innerHTML = "Hiring starts on :";
                    document.getElementById("finishHiring").innerHTML = "Finishing starts on :";
                    document.getElementById("totalDays").innerHTML = "Total days : ";
                    document.getElementById("hiringPrice").innerHTML = "Hiring Price : £";

                    $('#chooseDateSection').empty();
                    $("#chooseDateSection").append(`
                ...
                if(typehiring == 0)
                {
                    ...
                    outraData.setDate(outraData.getDate() + 1); // Adiciona 1 dias
                    ...
                    //  alert(newDay);
                      ...
                      var dateJustCreated3 = `${newMonth}/${newDay}/${newYear}`;
                    ...
                    document.getElementById("inputfinishHiring").value = dateJustCreated;
                    ...
                    $("#chooseDateSection").append(`
                        ...
                        <label for="start" style="color:black!important;">Start date:</label>
                            ...
                            value="`+ dataComecoPadraoDateTime +`" hidden>

                            <input type="text" id="Showingstart"
                            value="`+ dataComecoPadraoDateTime +`" disabled>
                      
                        <label for="start" style="color:black!important;">Final date:</label>
                            <input type="text" id="end" name="dataFimPadraoDateTime"
                            value="`+ dateJustCreated3 +`" hidden>

                            <input type="text" id="ShowingEnd" 
                            value="`+ dateJustCreated3 +`" disabled>



                              <label for="start" style="color:black!important;">Start date:</label>
                                  <input type="date" id="start" name="dataComecoPadraoDateTime"
                                  value="`+ dataComecoPadraoDateTime +`"
                                  min="`+ dataComecoPadraoDateTime +`" max="`+ dataComecoPadraoDateTime +`">

                                  <input type="date" id="end" name="dataFimPadraoDateTime"
                                  value="`+ dateJustCreated3 +`"
                                  min="`+ dateJustCreated3 +`" max="`+ dateJustCreated3 +`">
                ...
                else if(typehiring == 1)
                {
                    ...
                    var outraData = new Date(dataComecoPadraoDateTime);
                    outraData.setDate(outraData.getDate() + 2); // Adiciona 2 dias
                    // alert(outraData.getDate());
                    var newDay = outraData.getDate();
                    var newMonth = outraData.getMonth() + 1;
                    var newYear = outraData.getFullYear();
                ...
                else if(typehiring == 3)
                {
                    ...
                    var outraData = new Date(dataComecoPadraoDateTime);
                    outraData.setDate(outraData.getDate() + 7); // Adiciona 7 dias
                    // alert(outraData.getDate());
                    var newDay = outraData.getDate();
                    var newMonth = outraData.getMonth() + 1;
                    var newYear = outraData.getFullYear();
