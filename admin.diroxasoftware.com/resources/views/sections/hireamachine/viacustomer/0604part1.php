                                ...
                                <div class="col-md-12">
                                      ...
                                      <div class="row">
                                            <div class="form-group col-md-4">
                                                  <label for="" style="color:black;"><b>TYPE MACHINE</b></label>
                                                              <select id="typemachine" name="typemachine" class="form-control categoriesOptions" >
                                                                  <option value="0">OUR MACHINE</option>
                                                                  <option value="1">CROSS HIRING MACHINE</option>
                                                              </select>
                                              </div>
                                      </div>
                                                ...
                                                <div class="row">
                                                      <div class="col-md-8">
                                                          <p style="color:black;"><b id="SuggestHiringPrice">Suggest Hiring Price:</b></p>
                                                      </div>

                                                      <div class="col-md-8">
                                                        <label for="discount" style="color:black!important;"><b>Hiring Price:</b></label>
                                                        <input type="text" id="hiringPrice" name="hiringPrice"
                                                            value="0" required><br>
                                                      </div>
                                                </div>
      ...
      $(document).ready(function(){
            ...
            // $('#ajaxSubmit').click(function(e){
              ...
              var discount  = $("#discount").val();
               var hiringNewPrice  = $("#hiringPrice").val();
              ...
              document.getElementById("totalDays").innerHTML = "Total days : "+   Math.round(total_days);
              document.getElementById("SuggestHiringPrice").innerHTML = "Suggest Hiring Price: £"+   hiringPrice2;
...
<script>
      $(document).ready(function(){
            ...
            // $('#ajaxSubmit').click(function(e){
              $(document).on("change", "#hiringPrice", function(e){
               e.preventDefault();
               var hiringNewPrice  = $("#hiringPrice").val();
               var discount  = $("#discount").val();
               var finalHiringNewPrice = (hiringNewPrice) - discount;
              document.getElementById("inputHiringPrice").value = finalHiringNewPrice;
              document.getElementById("hiringPrice").value = hiringNewPrice;
...
<script>
    $("#inputHiringPrice").on("change",function(){
      $(this).val(parseFloat($(this).val()).toFixed(2));
    });
</script>
