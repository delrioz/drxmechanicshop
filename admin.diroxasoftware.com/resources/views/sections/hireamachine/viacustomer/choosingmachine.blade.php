                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        ?>
                                                ...
                                                <p style="color:black;"><b id="hiringPrice">Suggest Hiring Price :</b></p>
                                                <label  style="color:black!important;"><b>Hiring Price :</b></label>
                                                <input type="input" id="hiringPriceField" name="hiringPriceField"
                                                    value="0.00" required><br>
...
<script>
      $(document).ready(function(){
            ...
            // $('#ajaxSubmit').click(function(e){
              ...
              // alert(dateJustCreated);
              // alert(dateEndJustCreated);
              ...
              findHiringPrice2 =findHiringPrice2.toFixed(2);
              findHiringPrice =findHiringPrice.toFixed(2);


              // if the hiring is 1, 2 ,3 or 1 week

              if(total_days == 2){
                findHiringPrice2 = machinePrice2days;
                findHiringPrice = findHiringPrice2;
              }
              else if(total_days == 3){
                findHiringPrice2 = machinePrice3days;
                findHiringPrice = findHiringPrice2;
              }
              else if(total_days == 7){
                findHiringPrice2 = machinePrice1week;
                findHiringPrice = findHiringPrice2;
              }
              ...
              document.getElementById("totalDays").innerHTML = "Total days : "+   Math.round(total_days);
              document.getElementById("hiringPrice").innerHTML = "Suggested Hiring Price : £"+   findHiringPrice2;
              ...
              document.getElementById("hiringPriceField").value = findHiringPrice;
...
<script>
      $(document).ready(function(){
            ...
            // $('#ajaxSubmit').click(function(e){
              ...
              var day_end = new Date(dataFimPadraoDateTime);
              var total_days = (day_end - day_start) / (1000 * 60 * 60 * 24);
              // var findHiringPrice = (Math.round(total_days) * machinePrice) - discount; antigo
              ...
              document.getElementById("finishHiring").innerHTML = "Finishing starts on :"+ dateEndJustCreated;
              document.getElementById("totalDays").innerHTML = "Total days : "+   Math.round(total_days);
              // document.getElementById("hiringPrice").innerHTML = "Suggested Hiring Price : £"+   findHiringPrice;
              // document.getElementById("firstDeposit").innerHTML = "First deposit Price (20%) :  £"+  firstDepositPercentage2;
...
<script>
    $("#firstDeposit").on("change",function(){
