                            ...
                            <h4 class="pb-2" style="color:black;"><b>Creating a Motorcycle. Please, fill out the form.</b></h4>
                              ...
                              <div class="form-row">
                                      ...
                                      <div class="form-group col-md-6">
                                              <label for="" style="color:black;"><b>SELL PRICE</b></label>
                                                <input id="valueMachine" name="valueMachine"
                                                  maxlength="191" value="{{ old('valueMachine') }}"
                                        ...
                                        <div class="form-group col-md-6">
                                              <label for="" style="color:black;"><b>COST PRICE MOTORCYCLE</b></label>
                                                <input id="costMachine" name="costMachine"
                                                      maxlength="191" value="{{ old('costMachine') }}"
                                                      placeholder="0.00" class="form-control" type="text" required>
                                        </div>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                   <label for="" style="color:black;"><b>Choose a Motorcycle Image</b></label>
                                   <input type="file" class="form-control-file" id="machineImage"  value="{{ old('machineImage') }}"
                                  name="machineImage" >
                                </div>
                               ...
                               <div class="title "><h3 style="text:center;">Preview Products</h3></div>
                                ...
                                <button type="submit" class="btn btn-warning">
                                  ...
                                  <b>Add a Motorcycle</b>
                                </button>
                                   @if($backRoute == 'indexInternalMachines')
...
<script>
    ...
    $("#price").on("change",function(){
      ...
      var price = document.getElementById("price").value;
      if(price == "NaN"){
            var new1dayprice =  (0).toFixed(2);
            document.getElementById("price").value = new1dayprice;
        }
