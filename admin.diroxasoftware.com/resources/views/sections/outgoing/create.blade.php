...
<head>
  ...
  <script type="text/javascript" src="{{ asset('jquery/multiselect/chosen.jquery.min.js') }}"></script>
    ...
    <form action="/section/outgoing/store" method="POST" id="registro" name="registro" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                   <label for="" style="color:black;"><b>Upload Image/ Pdf File</b></label>
                            ...
                            <div class="form-row">
                              ...
                              <!-- <input type="checkbox" id="outgoingcheck" name="outgoingcheck" value="addtooutgoing">
                              <label for="outgoingcheck"><b>Add to Outgoing table</b></label><br> -->
