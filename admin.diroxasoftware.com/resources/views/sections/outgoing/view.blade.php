                      ...
                      @endif
                              ...
                              <div class="form-group col-md-6">
                                <label for="" style="text-align:center;color:black;"><b>Category</b></label>
                                        <select id="category" name="category" class="form-control categoriesOptions" disabled>
                                            <?php
                                                $max3 = 130;
                                                $str = " $thiscategoryName ";
                                                $thiscategoryName=  substr_replace($str, (strlen($str) > $max3 ? '...' : ''), $max3);
                                            ?>
                                            <option value="{{$thiscategoryid}}" selected disabled>{{$thiscategoryName}}</option>
                                            ...
                                            <option value="{{$allcategory->id}}" disabled>{{$name}}</option>
                                            @endforeach
                                        </select>
                                    <!-- or <a href="/newone" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><b>Add new category</b></a> -->
                              </div>
                              ...
                              <input id="brand" name="brand"
                                            ...
                                            placeholder="Keep it empty for no brand" class="form-control" type="text" disabled>
                              </div>
                          </div>
                                        ...
                                        <label for="" style="color:black;"><b>Condition</b></label>
                                            <select id="condition" name="condition" class="form-control categoriesOptions" disabled>
                                                @if($alloutgoing->condition == 'none')
                                                    ...
                                                    <option id="option" value="{{$alloutgoing->condition}}" selected disabled>{{$alloutgoing->condition}}</option>
                                                    <option>USED</option>
                                  ...
                                  <label for="" style="color:black;"><b> Observation: </b></label>
                                      ...
                                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                          name="about" placeholder="Observation"
                                           value="{{$alloutgoing->about}}"  id="about" disabled >{{$alloutgoing->about}}</textarea>
                              </div>

                          </div>
                              <a type="button" href="/section/reports/outgoing" class="btn btn-success">
                              <i class="fa fa-exits fa-1x " aria-hidden="true"></i>
                              <b>Back Outgoing</b></a>
                          </form>
                      </div>
                  </div>
