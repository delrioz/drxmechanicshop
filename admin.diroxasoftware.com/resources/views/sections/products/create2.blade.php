        ...
        <div class="row ">
            <div class="col-md-4 py-5 bg-primary text-white text-center "
             id="btnRoxo">
                <div class=" ">
                    <div class="card-body">
                        <h2 class="py-3">Adding new Products</h2>
                <br>
                      </div>
                  </div>
              </div>
                  ...
                  <h4 class="pb-4">Por favor, preencha todos os campos.</h4>
                      ...
                      <div class="form-row">
                          ...
                          <input id="serial_number" name="serial_number" 
		                          maxlength="191" 
		                         placeholder="serial_number" class="form-control" type="text" required>
                          	...
                          	<div class="form-group col-md-6">
		                        <input id="categorie" name="categorie" 
		                          maxlength="191" 
		                         placeholder="categorie" class="form-control" type="text" required>
	                        </div>
                       </div>
                      ...
                      <div class="form-row">
                          ...
                          <input id="situation" name="situation" 
		                          maxlength="191" 
		                         placeholder="situation " class="form-control" type="text" required>
                          	...
                          	<div class="form-group col-md-6">
		                        <input id="year" name="year" 
		                          maxlength="191" 
		                         placeholder="Year" class="form-control" type="text" required>
	                        </div>
                       </div>
                          ...
                          <input id="brand" name="brand" 
                          	...
                          	<div class="form-group col-md-6">
		                        <input id="image" name="image" 
		                          maxlength="191" 
		                         placeholder="image" class="form-control" type="text" required>
	                        </div>
                       </div>
                      <div class="form-row">
                          <div class="form-group col-md-6">
                          <input id="price" name="price" 
		                          maxlength="191" 
		                         placeholder="price " class="form-control" type="text" required>
