                ...
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            <h4 class="pb-2" style="color:black;"><b>Editing a Product.</b></h4>
                            @if($errors->any())
                              ...
                              @endif
                                ...
                                <div class="form-row">
                                    ...
                                    <label for="" style="text-align:center;color:black;"><b>Name</b></label>
                                        <input id="name" name="name"  id="name"  placeholder="Name" class="form-control"
                                        value = "{{$allproducts->name}}" type="text"
                                         required>
                                    </div>
                              ...
                              <label for="" style="text-align:center;color:black;"><b>SKU</b></label>
                                    <input id="SKU" name="SKU"
                                            ...
                                            value = "{{$allproducts->SKU}}" requireds>
                          ...
                          <div class="form-row">
                                  <div class="form-group col-md-6">
                                  <label for="" style="text-align:center;color:black;"><b>Sell Price</b></label>
                              ...
                              @if($allproducts->isTheVatFree == "no")
                          ...
                          @if($allproducts->isTheVatFree == "yes")
                            <div>
                              <input type="checkbox" id="vatFree" name="vatFree" checked>
                          ...
                          @endif
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                        <label for="" style="text-align:center;color:black;"><b>Cost Price</b></label>
                                        <input id="Cost_Price" name="Cost_Price"
                                                maxlength="191"
                                                placeholder="Cost_Price" class="form-control" type="text"
                                        value="{{$allproducts->Cost_Price}}"
                                        required>
                                </div>
                        ...
                        <div class="form-group col-md-6">
                              <label for="" style="text-align:center;color:black;"><b>Supplier</b></label>
                                      <select id="supplier" name="supplier" class="form-control" >
                                          <?php
                                              $max3 = 130;
                                              $str = " $supplierFoundName ";
                                              $supplierFoundName=  substr_replace($str, (strlen($str) > $max3 ? '...' : ''), $max3);
                                          ?>
                                        <option value="{{$supplierFoundId}}" selected >{{$supplierFoundName}}</option>
                                          @foreach($allSuppliers as $allsupplier)
                                          <?php
                                              $max = 130;
                                              $str = " $allsupplier->name ";
                                              $name=  substr_replace($str, (strlen($str) > $max ? '...' : ''), $max);
                                          ?>
                                          <option value="{{$allsupplier->id}}">{{$name}}</option>
                                          @endforeach
                                        </select>
                        ...
                        <div class="col-md-4">
                                        <label for="" style="color:black;"><b>Condition</b></label>
                                            <select id="condition" name="condition" class="form-control" >
                                                @if($prodCondition == 'none')
                                                    <option>NEW</option>
                                                    <option>USED</option>

                                                    @elseif($prodCondition == 'NEW')
                                                    <option id="option" value="{{$prodCondition}}" selected>{{$prodCondition}}</option>
                                                    <option>USED</option>

                                                    @elseif($prodCondition == 'USED')
                                                    <option id="option" value="{{$prodCondition}}" selected>{{$prodCondition}}</option>
                                                    <option>NEW</option>
                                                @endif
                                              </select>
                              ...
                              <div class="form-row">
                                      <label for="" style="text-align:center;color:black;"> <b>About</b>: </label>
                                          <div class="form-group col-md-12">
                                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                              name="about" placeholder="about" id="about" value="{{$allproducts->about}}" required>{{$allproducts->about}}</textarea>
                              </div>


                              <div class="form-group col-md-6">
                              @if($allproducts->image !=null)
                                      <img src="/storage/{{$allproducts->image}}""
                                      alt="{{ $allproducts->image}}" style= "max-width: 250px;">
                              @endif
                              <div class="form-group col-md-6">
                              ...
                              @elseif($backRoute == 'indexProducts')
              ...
              <div class="row">
                  <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input id="categoryName" categoryName="categoryName"  id="categoryName"  placeholder="Supplier" class="form-control" type="text" required>
                        </div>
                  </div>
              </div>
                <div class="form-group">
