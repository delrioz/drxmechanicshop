...
<head>
                ...
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            ...
                            <div class="row">
                              <div class="form-group col-md-12">
                              <label for="" style="color:black;"> Choose Machine: </label>
                         ...
                         <div class="col-md-12">
                              @if(count($allproducts)  > 0)
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                      ...
                                      <select id="mselect" multiple style="width:300px;"  name="Productsoptions[]" class="categoriesOptions" onchange="doOnChange();">
                          ...
                          <div class="row">
                              <div class="col-lg-4">
                                <button type="submit" class="btn btn-warning ajaxSubmit" id="ajaxSubmit">Create a Quote and Add Quantities</button>
                            </form>
                            </div>
                            <div class="col-md-6">
                            <!-- <form action="/section/quote/store" method="POST" id="registro" name="registro" enctype="multipart/form-data">
                            @csrf
                                <button type="submit" class="btn btn-warning">Create a Quote and Add Quantities</button>
                            </form> -->
                            </div>
                          </div>
 ...
 <script type="text/javascript">
  ...
  function doOnChange(){
    ...
    var form = document.getElementById('mselect').value.0;
          alert('dados');
          alert(form);
          };
  </script>
...
<script>
      $(document).ready(function(){
        ...
        alert(`oi`)
        $('.option').empty();
        document.getElementByClassName('categoriesOptions').value = '';
