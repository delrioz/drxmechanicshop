...
<div class="container-fluid invoice-container">
 ...
 <header>
  ...
  <div class="row">
    ...
    <div class="col-sm-6 text-sm-right" style="color:black;"> <strong>Quote No:</strong> #{{$newInvoiceId}}</div>
  ...
  <form action="/section/OpenWorkOrder/" method="POST" id="registro" name="registro" enctype="multipart/form-data">
    <div class="row">
      ...
      <div class="col-sm-6 order-sm-0" style="color:black;"> <strong>Quote To:</strong>
        <address style="color:black;">
        <strong style="color:black;">{{$allworkOrders->customerName}}<br /></strong>
    ...
    <div class="row">
        ...
        <div class="col-sm-5" style="color:black;"> <span class="text-black text-uppercase">Date Exit</span><br>
          <span class="font-weight-500 text-3" style="color:black;">{{$todayDate}}</span> </div>
      </div>
    <hr>
  ...
  <div class="row p-3">
      ...
      @foreach($ProductsInfo as $prod)
              <?php
                 ...
                 $qtd = number_format($prod->pmqProductQuantity, 2, '.',',');
      ...
      @foreach($allextraitems as $extraitems)
                              ...
                              <?php
                                ...
                                $extraSellPrice = number_format($extraitems->Sell_Price, 2, '.',',');
                              ...
                              ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="color:black;">£{{$extraSellPrice}}</td>
                                        <td style="color:black;">£{{$extraSellPrice}}</td>
                                    </tr>
                                </tbody>
                        @endforeach
            ...
            <div class="row">
              <div class="col-md-6">
                    <tr>
                        <!-- <p class="font-weight-bold">Service/ Labour: <strong> £{{$quotepreviewinvoice}}</strong></p> -->
                    </tr>
              </div>
            <div class="col-md-6">
            </div>
      ...
      <div class="table-responsive">
        <table class="table">
          ...
          @endif
            ...
            <!-- <a href="/section/quotesAlreadyDone/" class="btn btn-warning border text-black-50 shadow-none" style="color:white;"><i class="fa fa-back"></i> Back</a> -->
            <a href="/section/quotesAlreadyDone/{{$allworkOrders->machine}}/MachineViewPage" class="btn btn-warning border text-black-50 shadow-none" style="color:white;"><i class="fa fa-back"></i> Back</a>
            </div>
       </form>
