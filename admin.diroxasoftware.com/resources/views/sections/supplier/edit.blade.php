      ...
      <span>
       ...
       <!-- Page Heading -->
         ...
         <!------ Include the above in your HEAD tag ---------->
            ...
            <form  id="myForm" enctype="multipart/form-data" action="/section/suppliers/update" method="POST">
                            @csrf
                              ...
                              <div class="invalidData" role="alert">
                                ...
                                <div class="form-row">
                                    ...
                                    <label for="" style="color:black;"> <b>Name:</b> </label>
                                        ...
                                        value="{{$findSupplier->name}}" required>
                                    </div>
                                @error('name')
                                ...
                                <div class="form-row">
                                    ...
                                    <input id="contactNumber" name="contactNumber"  value="{{$findSupplier->contactNumber}}"
                                            maxlength="191" 
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="contactEmail" id="contactEmail" name="contactEmail" value="{{$findSupplier->contactEmail}}"
                                            maxlength="191" 
                                ...
                                <div class="form-row">
                                    ...
                                    <input id="location" name="location" value="{{$findSupplier->location}}"
                                            maxlength="191" 
                                ...
                                <label for="" style="color:black;"><b> Note: </b></label>
                                      ...
                                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                          ...
                                          value="{{ old('note') }}" id="note" >{{$findSupplier->note}}</textarea>
                              </div>


                              <input type="text" value="{{$findSupplier->id}}" name="supplierId" id="supplierId" hidden>
