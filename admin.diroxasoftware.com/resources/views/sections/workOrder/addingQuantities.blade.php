...
<body id="page-top">
      ...
      <span>
        ...
        <div class="container-fluid">
         ...
         <form action="/section/workOrder/confirmQuantity" method="POST" id="registro" name="registro" enctype="multipart/form-data">
              @csrf
                            ...
                            <label for="" style="color:black;"> <b>Title:</b> </label>
                                ...
                                <div class="form-group col-md-12">
                                    <input id="title" name="title"  id="title"  placeholder="title" class="form-control" type="text"
                                           value = "{{$allwk->title}}" disabled required>
                                </div>
                            </div>
                            <div class="form-row">
                                    <label for="" style="color:black;"><b>Customer Report:</b></label>
                                        <div class="form-group col-md-12">
                                        <input type="text" value="{{$allwk->customer_report}}" name ="customer_report" hidden>  
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                name="customer_report"
                                                placeholder="Customer Report" id="customer_report" disabled>{{$allwk->customer_report}}</textarea>
                                  </div>
                            </div>
                            ...
                            <div class="form-row">
                                      <label for="" style="color:black;"> <b>Customer Note:</b> </label>
                                          ...
                                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                ...
                                                placeholder="Last Observations" id="last_observations" disabled>{{$allwk->last_observations}}</textarea>
                              </div>
                            ...
                            <div class="form-group col-md-6">
                                       <label for="" style="color:black;"> <b>Customer</b> </label>
                                        ...
                                        <select id="customer" name="customer" class="form-control" disabled>
                                          <option selected>{{$allwk->customerName}}</option>
                                      </select>
                              </div>


                            <div class="form-group col-md-6">
                                        <label for="" style="color:black;"> <b>Motorcycle<b></b> </label>
                                        <input type="text" value="{{$allwk->machineId}}" name ="machine" hidden>  
                                        <select id="machine" name="machine" class="form-control" disabled>
                                         <option selected>{{$allwk->machineModel}}</option>
                                        </select>
                              </div>
                            ...
                            <div class="row">
                                    @if(count($allproducts)  > 0)
                                        <div class="form-group">
                                            ...
                                            @if($statusNulo == true)
                                              @foreach($outrasop as $op)
                                               <option id="option" value="{{$op->product_id}}" selected>Id:{{$op->id}}| {{$op->productName}}</option>
                                              @endforeach
                                            @endif
                                              </select>
                                          </div>
