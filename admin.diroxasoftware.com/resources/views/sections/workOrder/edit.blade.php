            ...
            @include('sections.components.topnavbar')
              ...
              <?php
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800"><b>Editing Work Orders</b></h1>
                                      ...
                                      <label for="" style="color:black;"><b>Customer Observations: </b></label>
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                    placeholder="Customer Report" disabled required>{{$allworkOrders->customer_report}}</textarea>
                                        </div>  
                                </div>  
                                          ...
                                          <label for="" style="color:black;"> <b>Customer Note:</b><small>(Will show on the Invoice)</small></label>
                                              <div class="form-group col-md-12">
                                                <textarea class="form-control"  rows="3"
                                                    ...
                                                    placeholder="Last Observations" id="last_observations" required>{{$allworkOrders->last_observations}}</textarea>
                                        </div>
                                </div>
                                              ...
                                              <div class="col-md-4">
                                                  ...
                                                  <div class="input-group mb-2 mr-sm-2">
                                                    ...
                                                    <input type="number"  class="form-control" name="quantity[]" id="quantity"  min="1" 
                                                          ...
                                                          value="{{$product->productQuantityPmw}}" placeholder="Quantity" required>
                                                  </div>
                                                </div>
                                              <div class="col-md-4">
                              ...
                              <div class="row">
                                    <div class="form-group col-md-7">
                                      <strong><h6 style="text-align:center; color:black;" ></strong>
                                        <b> WORK ORDER ORDER STATUS</b>
                                      </h6>
                                      <select id="wkStatus" name="wkStatus" class="form-control">
                                              @if($allworkOrders->status == 0)
                                                  <option>OPEN</option>
                                                  <option>WAITING FOR COLLECTION</option>

                                              @elseif($allworkOrders->status == 2)
                                                  <option>READY AND WAITING FOR COLLECTION</option>
                                                  <option>OPEN</option>
                                              @endif
