...
<div class="container-fluid invoice-container">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 text-sm-right" style="color:black;"> <strong>Invoice No:</strong> #{{$ThisWkInvoice}}</div>
  ...
  <div class="col-md-12">
      ...
      @foreach($ProductsInfo as $prod)
        ...
        @endforeach
        @if(isset($totalExtraItemsStatus))
            @if($totalExtraItemsStatus != "empty")
                          @foreach($allextraitems as $extraitems)
                                  <?php
                                    ...
                                    $extraitemsPrice = number_format($extraitems->Sell_Price, 2, '.',',');
                                  ...
                                  ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="color:black;">£{{$extraitemsPrice}}</td>
                                            <td style="color:black;">£{{$extraitemsPrice}}</td>
                                        </tr>
                                    </tbody>
                            @endforeach
        ...
        <table class="table">
          <tbody>
            ...
            @csrf
              ...
              <a href="/section/machines/viewPage/{{$Machine_Id}}" class="btn btn-warning border text-black-50 shadow-none" ><i class="fa fa-back" style="color:white!important;"></i> Back</a> </div>
            </div>
       </form>
