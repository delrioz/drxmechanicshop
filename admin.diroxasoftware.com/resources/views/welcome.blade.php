              ...
              <div class="container-fluid">
                  ...
                  <div class="alert alert-warning">
                        <p>You don't have any appointments for today.
                          You can also <a href="/section/appointments/create/">BOOK AN APPOINTMENT</a></p>
                          Click here to
                          <button type="button" class="btn btn-success" id="createInvoice" name="createInvoice"
                  ...
                  @else
                  <div class="alert alert-warning">
                        <p>You have {{$Nappointments}} appointments for today. You can Also <a href="/section/appointments/create/">BOOK AN APPOINTMENT</a></p>
                        <a href="/section/appointments/index/">See all appointments</a>
                                  ...
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                              <a href="/section/customers">Customer Active</a> </div>
                                          <div class="h5 mb-0 font-weight-bold text-gray-800">
                                              <p>{{$Ncustomer}}</p>
                                              <a type="button" href="/section/customers" class="btn btn-primary" >
                                                  <i class="≈fa-1x " aria-hidden="true"></i>
                                                    <b>Add New Customers</b></a>
                                          </div>
                                      </div>
                                      <div class="col-auto">
                                      </div>
                                  ...
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              <a href="/section/workOrder/index/">Work Orders Activies</a></div>
                                              <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                  <p>{{$NworkOrder}}</p>
                                                  <a type="button" href="/section/workOrder/create/" class="btn btn-primary" >
                                                  <i aria-hidden="true"></i>
                                                    <b>Make New Work Order</b></a>
                                              </div>
                                      </div>
                                      <div class="col-auto">
                                        </div>
                              ...
                              <div class="card-body">
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          ...
                                          <a href="/section/quote/">Quotes</a>
                                          </div>
                                          <div class="row no-gutters align-items-center">
                                              <div class="col-auto">
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                  <p>{{$Nquote}}</p>
                                                  <a type="button" href="/section/quote/create" class="btn btn-primary" >
                                                  <i aria-hidden="true"></i>
                                                    <b>Create new Quotes</b></a>
                                                </div>
                                              </div>
                                          </div>
                                      </div>
                                  ...
                                  <div class="row no-gutters align-items-center">
                                      <div class="col mr-2">
                                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                              <a href="/section/reports/SalesReports">Earnings From Today</a></div>
                                              <div class="col-auto">
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        <p>£{{$totearningstoday}}</p>
                                                        <a class="btn btn-primary" href="/section/reports/SalesReports">
                                                            <b>View Sales Reports</b>
                                                        </a>
                                                </div>
                                              </div>
                                      </div>
                      ...
                      <div class="col-lg-3 mb-12">
                          <div class="card shadow mb-3">
                            <div
                              ...
                              <div class="card-body">
                                <img src="/storage/{{$ProductbestSeller->image}}" class="card-img-top" style="width: 180px; height: 180px;!important">
                                <br>
                                <ul>
                ...
                @endif
                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-primary"><h5 style = "color:orange"><strong>Quick Search Section</strong>
                    </div>
                    <!-- Card Body -->
                      <div class="card-body">
                          <div class="card-body">
                            <br>
                            <input type="text" class="typeahead form-control searchBox" placeholder="Search" name="searchBox" id="searchBox" onChange="searchFunct(searchBox);">
                            <br>
                            <label for="searchByOptions"><strong><b>Search By Motorcycle's number plate</b></strong></label>
                            <select name="searchByOptions" id="searchByOptions" hidden>
                                <option value="numberPlate">Number Plate/ Sku</option>
                                <!-- <option value="customerName">Customer Name</option> -->
                              </optgroup>
                            </select>
                          <div class="row ulBikes" id="ulBikes" name="ulBikes"></div>
                          </div>
                          </div>
                      </div>
                  </div>
                          ...
                          <div class="card-body">
                              <div class="card-body">
                                  @foreach($productslowquantities as $lowQuantitys)
                                    <div class="h5 mb-0 font-weight-bold text-black-800" style="color:black;">{{$lowQuantitys->name}}<small style="color:red;"> only {{$lowQuantitys -> quantity}} items</small> <a href="/section/products/edit/{{$lowQuantitys->id}}"> add more</a>
                                    </div>
                                  @endforeach
                ...
                <div class="container">
                  <span id="tableTitle" class="d-none">
                        <div class="title ">
                          <div class="alert alert-warning">
                              <h5>Datas Found</h5>
                              Couldn't find? <a href="/section/customers/create">Add new Customer</a>
                          </div>
                        </div>
                ...
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            <h4 class="pb-2" style="color:black;"><b>Adding a Motorcycle. Please, fill out the form</b></h4>
                            @if($errors->any())
                                ...
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <input id="mileage" name="mileage"
                                            ...
                                            placeholder="mileage" class="form-control" type="number" required>
                                  </div>
                                </div>
                                <br>
                                      ...
                                      <div class="col-md-12">
                                        <label for="" style="color:black;"><b> Observations: </b></label>
                                              ...
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                                  ...
                                                  value="{{ old('observations') }}" id="observations" ></textarea>
                                      </div>
                                  </div>
        ...
        // alert(1);
            ...
            // $('#ajaxSubmit').click(function(e){
              $(document).on("change", "#searchBox", function(e){
                ...
                var searchByOptions = $('#searchByOptions option:selected').val();
                // alert(inputSearch);
                    ...
                    if($resp == 0){
                        ...
                        if(searchByOptions != "customerName")
                        {
                          $(".ulBikes").append(`
                              <ul>
                                <li>
                                  Couldn't Find?
                                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Add a new One</button>
                      ...
                      if(searchByOptions == "customerName"){
                        ...
                        document.getElementById('searchBox').value = '';
                          ...
                          $(".ulBikes").append(`
                              <ul>
                                <li>
                                  <a href="/section/machines/viewPage/` + value.id + `">
                                  Bike Model: ` + value.model + `
                                  Plate: ` + value.serial_number + `
                                  </a>
                                </li>
                              </ul>
                          `);
                      ...
                      <div class="row">
                        <ul>
                          <li>
                          Couldn't Find?
                          <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bd-example-modal-lg">Add a new One</button>
                          </li>
                        </ul>
                        </div>
                    `);
